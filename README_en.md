...
hotnews wallstcn   # Wallstreetcn Trending
```
...
| `fetchBaidu()` and 10 more | Named per-source functions returning `Promise<NewsItem[]>` |
...
| Wallstreetcn Trending | `wallstcn` | Wallstreetcn hot articles |

...
`hotnews` — CLI trending news aggregator fetching hot topics from 10 sources across Chinese platforms and GitHub. Also importable as an npm library (ESM + CJS). Built with React Ink + TypeScript + Bun.
